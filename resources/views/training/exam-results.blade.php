        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    ...
                    <p class="mt-1 text-sm text-gray-500">{{ __('Results appear here after your trainer or WRRB staff records your examination marks.') }}</p>
                </div>
                <div class="p-6">
                        ...
                        <div @class(['border-b border-gray-200 pb-4 mb-4' => ! $loop->last])>
                            ...
                            <dl class="mt-4 grid gap-3 sm:grid-cols-3 text-sm">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-0.5 text-gray-900">{{ $application->exam_uploaded_at?->format('Y-m-d H:i') }}</dd>
                                </div>
                            </dl>
                    ...
                    <div class="p-6 space-y-3">
                        @foreach($awaitingResults as $application)
                            <div class="flex flex-wrap items-center justify-between gap-2 text-sm">
                                ...
                                <span class="text-amber-900">{{ __('Results not yet published') }}</span>
                            </div>
                        @endforeach
                    </div>
